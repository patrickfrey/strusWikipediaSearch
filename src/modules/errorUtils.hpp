...
/// \file errorUtils.hpp
#ifndef _STRUS_WIKIPEDIASEARCH_ERROR_UTILITIES_HPP_INCLUDED
#define _STRUS_WIKIPEDIASEARCH_ERROR_UTILITIES_HPP_INCLUDED
#include <stdexcept>
#define _TXT(txt) txt  // No internationalization of the error messages

#define THIS_COMPONENT_NAME	"strus base"
