...
"$w2wprefix"word2vec -size 300 -window 8 -sample 1e-5 -negative 8 -threads 24 -min-count 2 -alpha 0.025 -classes 0 -debug 1 -binary 1 -portable 1 -save-vocab "$outprefix"vocab.txt -cbow 0 -train "$outprefix"docs.word2vec.txt -output "$outprefix"vectors.bin
